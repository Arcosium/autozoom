...
class BartLoader(ModelLoader):
    ...
    def set_config(self, config, model, tokenizer):
        config.bos_token = «REDACTED»
        config.eos_token = «REDACTED»
        config.unk_token = «REDACTED»
        config.decoder_start_token = «REDACTED»
...
class T5Gemma2Loader(ModelLoader):
    ...
    def set_config(self, config, model, tokenizer):
        config.bos_token = «REDACTED» "bos_token", None)
        config.eos_token = «REDACTED» "eos_token", None)
        config.unk_token = «REDACTED» "unk_token", None)
        config.decoder_start_token = «REDACTED» "bos_token", None)
